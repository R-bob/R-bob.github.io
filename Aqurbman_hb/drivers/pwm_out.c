...
//	RCC_APB2PeriphClockCmd(RCC_APB2Periph_TIM8, ENABLE);
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA|RCC_AHB1Periph_GPIOE, ENABLE);//(RCC_AHB1Periph_GPIOA|RCC_AHB1Periph_GPIOC|RCC_AHB1Periph_GPIOE, ENABLE);
...
//	TIM1->CCR1 = PWM_RADIO *( pwm_tem[CH_out_Mapping[3]] ) ;				//4
	
 	TIM5->CCR4 = PWM_RADIO *( pwm_tem[CH_out_Mapping[3]] ) ;				//5	
