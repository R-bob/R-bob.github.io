...
#define LCD_SCL_H GPIO_SetBits(GPIOB,GPIO_Pin_15) 
#define LCD_SCL_L GPIO_ResetBits(GPIOB,GPIO_Pin_15) 
...
#define LCD_DC_H  GPIO_SetBits(GPIOB,GPIO_Pin_12) 
#define LCD_DC_L  GPIO_ResetBits(GPIOB,GPIO_Pin_12) 
